...
class Login():
    ...
    def index(self,module,modulelist = []):
        ...
        if n == 0:
            return print('该用户名下没有%s模块'%module)
...
if __name__ == '__main__':
    test = Login('95601','a123456','http://basic.uat.fineex.net:8090/Home/Index')
