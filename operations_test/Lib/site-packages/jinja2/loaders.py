...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'home.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/home.html'`` the file from the app1 package is loaded,
    by loading ``'app2/home.html'`` the file from the second.
    """
